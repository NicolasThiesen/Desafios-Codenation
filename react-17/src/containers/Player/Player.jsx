...
const Player = ({playingNowId,playingNowTrack, dispatch}) => {
...
export default connect(state=>({playingNowId: state.content.playingNowId, playingNowTrack: state.content.playingNowTrack}))(Player);